...
public enum PieceColor {
    ...
    WHITE() {
        ...
        @Override
        public Player choosePlayerByAlliance( WhitePlayerImpl whitePlayerImpl,
                                              BlackPlayerImpl blackPlayerImpl) {
    ...
    public abstract Player choosePlayerByAlliance(WhitePlayerImpl whitePlayerImpl, BlackPlayerImpl blackPlayerImpl);
