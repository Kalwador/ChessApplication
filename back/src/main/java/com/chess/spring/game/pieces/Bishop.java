...
public class Bishop extends AbstractPiece {
    ...
    private static boolean isFirstColumnExclusion(int currentCandidate,
        ...
        return (BoardConfiguration.getInstance().FIRST_COLUMN.get(candidateDestinationCoordinate) &&
                ((currentCandidate == -9) || (currentCandidate == 7)));
    }

    private static boolean isEighthColumnExclusion(int currentCandidate,
                                                   int candidateDestinationCoordinate) {
        return BoardConfiguration.getInstance().EIGHTH_COLUMN.get(candidateDestinationCoordinate) &&
